...
namespace ProloAPI
{
    ...
    namespace Extensions
    {
        ...
        public static class PGeneral
        {
			...
			/// <returns></returns>
			public static IEnumerable<T2> Attempt<T1, T2>(this IEnumerable<T1> obj, Func<T1, T2> check)
			{
        ...
        public static class PGame
        {
            ...
            /// <typeparam name="T"></typeparam>
            /// <returns></returns>
            public static IEnumerable<T> GetAllChaFuncCtrlOfType<T>(this T mod)
                where T : CharaCustomFunctionController
                => Utilities.PGeneral.GetAllChaFuncCtrlOfType<T>();
