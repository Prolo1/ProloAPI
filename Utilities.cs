...
namespace ProloAPI
{
    ...
    namespace Utilities
    {
        ...
        public class PGeneral
        {
            ...
            public static Texture2D greyTex
            {
                get
                {
                    ...
                    return _greyTex = CreateColourTexture(Color.black);
                }
            }
            ...
            /// <returns></returns>
            public static Texture2D CreateColourTexture(Color colour)
            {
        ...
        //t = knife
        //t = boot
        internal static class DummyChara<T> where T : CharaCustomFunctionController
        {
        ...
        public class PGUI
        {
            ...
            public static void IMGUITooltipMsg(string tooltip = null, bool enableTip = true)
            {
                ...
                if(enableTip && !tooltip.IsNullOrEmpty())
                {
                    if(tmpSty == null)
                    {
                        var tex = CreateColourTexture(new Color(0, 0, 0, .5f));
